...
Each section needs a "key" field using these exact values — "life", "heart", "head", "fate", "sun", "mercury", "girdle", "marriage" — or null for the closing "Overall Character" section. This lets the app match each section to a fixed reference diagram of that line regardless of what language the heading is written in. This key must always stay in English/lowercase even when the heading and text are in Hindi.
